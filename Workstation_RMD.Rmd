...
```
```{r date_separation, echo=FALSE}
# Separate Date column into three separate cols with year, month, date
...
Department_count <- counted_Dept %>%
  arrange(desc(n))

kable(Department_count, caption = "Total Visits by Department")
